...
const Banner = () => {
 ...
 <div className='relative w-50 mt-20'>
  <input
    ...
    name="search"
    id="default-search"
    className="block w-full p-4 pl-10 text-sm text-black border border-gray-300 rounded-lg bg-white focus:ring-red-500 focus:border-red-500 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
